...
namespace ImageGallery.Client.HttpHandlers
{
    public class BearerTokenHandler : DelegatingHandler
    {
        ...
        // check if token is almost expired if so refresh it
        public async Task<string> GetAccessTokenAsync()
        {
            // get the expires at value & parse it
            ...
            // if token doesn't expire in 60 seconds or less
            ...
            _logger.LogInformation($"Refresh Token is {refreshResponse.RefreshToken}");
